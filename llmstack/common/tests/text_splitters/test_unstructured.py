...
class TestUnstructuredTextSplitter(unittest.TestCase):
    ...
    def test_spacy_splitter(self):
        ...
        print("=== test_spacy_splitter ===")
        for _chunk in chunks:
            print("-" * 80)
            print(_chunk.replace(r"\n\s*\n", " "))
            print("\n")
...
--------------------------------------------------------------------------------
Creating a comprehensive story on Mumbai that delves into various topics is a fascinating endeavor.

Mumbai, the financial capital of India, is a city of dreams, contrasts, and enduring spirit.

Let's explore this dynamic metropolis through different lenses: its rich history, vibrant culture, economic significance, architectural marvels, and the challenges it faces.
...
Mumbai is a city of contrasts, where tradition and modernity coexist, facing numerous challenges but always looking towards the future with hope and determination.

Its rich history, vibrant culture, economic significance, and architectural marvels make it a unique and fascinating city, while the resilience and spirit of its people ensure it continues to thrive and evolve.




.=== test_unstructured_text_splitter ===
